                ...
                <div class="col-sm-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <span>通知列表</span>
                            <h4 onclick="showAddView()">新增通知<span class="glyphicon glyphicon-chevron-right" id="arrowLogo"></span></h4>
                        </div>
                        <div class="row" id="addDiv" style="display: none">
                            ...
                            <button onclick="save()" class="btn btn-primary " type="button"><i class="fa fa-check"></i>&nbsp;提交</button>
                        </div>
